...
export default function Nota(props) {
  ...
  const [openModalHistory, setOpenHistory] = useState(false);
  ...
  const historial = async (row) => {
    handleModalHistory();
    //console.log(baseUrlNota + "/history/" + row.idNota);
    await axios
      .get(
        baseUrlNota + "/history/" + row.idNota,
  ...
  return (
    <div>
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="center">Dep.</StyledTableCell>
      ...
      >
        ...
        <DialogActions>
          <Button variant="text" color="inherit" onClick={handleModalHistory}>
            Cancelar
          </Button>
          <Button
            variant="contained"
