  ...
  const handleChange = (event, newValue) => {
    setValue(newValue);
        ...
        const Update=async(event)=>{
          ...
          await axios.patch(baseUrl+"/"+idNoticia,
            JSON.stringify({
              "titulo":data.titulo,
        ...
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h1 className={classes.cardTitleBlack}>Editar Noticia</h1>
            ...
            <form onSubmit={Update} id="create-course-form">
              <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={2} align="center" style={{ width: 70 }}>                    
                    <Box sx={{ bgcolor: 'info.main', color: 'info.contrastText',mt:3, p: 1 ,borderRadius: '30px' }}>          
            ...
            <>
                <Grid item xs={12}>
                    <Item>
                        ...
                        multiline
                        onChange={handleChangle}
                        fullWidth label="contenido" id="contenido" name="contenido" />
                    </Item>
                </Grid>
            </>
            :'' }
